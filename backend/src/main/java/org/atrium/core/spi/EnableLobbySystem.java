...
/**
 * Explicit opt-in annotation for host applications that prefer annotation-driven
 * wiring over Spring Boot auto-configuration discovery.
 *
 * <p>In Spring Boot apps, adding the Atrium dependency is already enough because
 * {@link LobbyAutoConfiguration} is listed under
...
@Import(LobbyAutoConfiguration.class)
public @interface EnableLobbySystem {
}
