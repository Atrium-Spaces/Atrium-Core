...
import org.atrium.core.redis.config.RedisLobbyConfiguration;
...
/**
 * Top-level lobby auto-configuration entry point.
 *
 ...
 * file) or {@code @Import(LobbyAutoConfiguration.class)} explicitly.
 *
...
@Import(RedisLobbyConfiguration.class)
public class LobbyAutoConfiguration {
	 ...
	 * module — both will be picked up by Spring Boot's auto-configured {@code ObjectMapper}.
	 */
	@Bean
	@ConditionalOnMissingBean(name = "lobbyDefaultGameSettingsModule")
	public Module lobbyDefaultGameSettingsModule() {
		SimpleModule module = new SimpleModule("LobbyDefaultGameSettingsModule");
	 ...
	 */
	public static Map<String, CorsConfiguration> corsConfigurations(LobbyProperties properties) {
